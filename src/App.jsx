...
function Episode4({ onComplete, onExit }) {
  ...
  const ep4Questions = [
    ...
    {
      id: "q2",
      question: "「急いで確認して」というSMSが届いたとき、うちの家族はどうする？今日、家族でルールを決めておこう。",
      questionEl: "「{急|いそ}いで{確認|かくにん}して」というSMSが{届|とど}いたとき、うちの{家族|かぞく}はどうする？{今日|きょう}、{家族|かぞく}でルールを{決|き}めておこう。",
      placeholder: "親子で話した内容を書いてみよう",
      placeholderEl: "{親子|おやこ}で{話|はな}した{内容|ないよう}を{書|か}いてみよう",
      hints: [
        "まず親に見せてから一緒に確認する",
        "公式アプリかブックマークからアクセスする",
        "SMSのリンクは絶対に押さない",
      ],
      hintsEl: [
        "{親|おや}に{見|み}せてから{一緒|いっしょ}に{確認|かくにん}する",
        "{公式|こうしき}アプリかブックマークからアクセスする",
        "SMSの{リンク|りんく}は{絶対|ぜったい}に{押|お}さない",
      ],
    },
  ];
  if (phase === "dialogue") return (
